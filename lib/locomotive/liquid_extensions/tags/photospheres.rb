        ...
        def render_photospheres(photospheres, &block)
          ...
          if photospheres
            ...
            photospheres.each do |photosphere|
              ...
              attributes = {'image' => photosphere.image_url(:photosphere_mobile), 'xml' => Rails.application.routes.url_helpers.locomotive_floorplan_photosphere_url(photosphere.floorplan_id, photosphere._id, only_path: true, format: :xml), 'coordinates' => photosphere.coordinates }
