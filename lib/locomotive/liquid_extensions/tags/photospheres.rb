        ...
        def render_photospheres(photospheres, &block)
          ...
          if photospheres
            ...
            photospheres.each do |photosphere|
              ...
              attributes = {'xml' => Rails.application.routes.url_helpers.locomotive_floorplan_photosphere_url(photosphere.floorplan_id, photosphere._id, only_path: true, format: :xml), 'coordinates' => photosphere.coordinates }
